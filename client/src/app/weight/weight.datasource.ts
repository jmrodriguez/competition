...
export class WeightDataSource extends DataSource<any> {
    ...
    connect(): Observable<Weight[]> {
        ...
        const source = Observable
            ...
            .merge(searchSource)
            .mergeMap((params: any) => {
                return this.weightService.list(this.search, this.paginator.pageIndex + 1, this.paginator.pageSize, this.sort.active, this.sort.direction);
            }).share();
