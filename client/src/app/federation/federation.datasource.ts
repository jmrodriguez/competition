 ...
 * should be rendered.
 */
export class FederationDataSource extends DataSource<any> {
    ...
    connect(): Observable<Federation[]> {
        ...
        const source = Observable
            ...
            .merge(searchSource)
            .mergeMap((params: any) => {
                return this.federationService.list(this.search, this.paginator.pageIndex + 1, this.paginator.pageSize, this.sort.active, this.sort.direction);
            }).share();
