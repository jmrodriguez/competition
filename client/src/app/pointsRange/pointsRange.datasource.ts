 ...
 * should be rendered.
 */
export class PointsRangeDataSource extends DataSource<any> {
    ...
    connect(): Observable<PointsRange[]> {
        ...
        const source = Observable
            ...
            .merge(searchSource)
            .mergeMap((params: any) => {
                return this.pointsRangeService.list(this.search, this.paginator.pageIndex + 1, this.paginator.pageSize, this.sort.active, this.sort.direction);
            }).share();
